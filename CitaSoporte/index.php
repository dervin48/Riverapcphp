...
<!--      <input type="hidden" required name="txtID" value="<?php // echo $txtID;?>" placeh0older="" id="txtID" require="">
    ...
    <input type="text" class="form-control <?php echo (isset($error['IDCLIENTE']))?"is-invalid":"";?>" name="txtIDCLIENTE"  value="<?php echo $txtIDCLIENTE;?>" placeholder="" id="txtIDCLIENTE" require="">
    <div class="invalid-feedback">
    <?php echo (isset($error['IDCLIENTE']))?$error['IDCLIENTE']:"";?>
    </div>
    <br>
    </div>
...
<div class="table-responsive-sm">
        ...
        <?php foreach($listaProductos as $DATO){ ?>
                <tr>
                    ...
                    <input type="hidden" name="txtID" value="<?php echo  $DATO['IDCITA']; ?>" >
                    <input type="hidden" name="txtIDCLIENTE" value="<?php echo  $DATO['IDCLIENTE']; ?>" >
                    <input type="hidden" name="txtDireccion" value="<?php echo  $DATO['IDCLIENTE']; ?>" >
